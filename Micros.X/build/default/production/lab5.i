...
main:
 ...
 loop:
    ...
    call displays ;funcion de mi
    clrf unidades
    clrf centenas
    clrf decenas
    call division ;funcion de separa nibbles
 goto loop
...
config_reloj:
    ...
    bsf ((OSCCON) and 07Fh), 6 ;Se selecciona la configuración 010
...
config_tmr0:
    ...
    bsf ((OPTION_REG) and 07Fh), 0 ;25ms
    reiniciar_tmr0
    return
